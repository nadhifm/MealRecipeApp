...
public class Recipe {
    ...
    public Recipe(long id, String title, String summary, String image, String imageType, int aggregateLikes, int readyInMinutes, int servings, List<Ingredient> extendedIngredients, List<AnalyzedInstruction> analyzedInstructions) {
        this.id = id;
        this.title = title;
